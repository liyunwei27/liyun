...
- [fitts_law_tremor_trial_data (1).csv](fitts_law_tremor_trial_data.csv) — raw trial data
...
- Screen-recording of the data-collection session: `[https://youtu.be/Hp1j-ndcHPU?si=SBN2T7p9VarwdXA1]`
