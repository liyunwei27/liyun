...
![Fitts' Law scatter plot with regression line](fitts_law_scatter_regression.png)

## Data & Materials

- [`fitts_law_tremor_trial_data.csv`](fitts_law_tremor_trial_data.csv) — raw trial data
- [`fitts_law_scatter_regression.png`](fitts_law_scatter_regression.png) — regression plot
